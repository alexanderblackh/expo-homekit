...
var ExpoHomekitNative = requireNativeModule("ExpoHomekit");
function getHomes() {
...
// src/events.ts
import { EventEmitter, requireNativeModule as requireNativeModule2 } from "expo-modules-core";
var emitter = new EventEmitter(
  requireNativeModule2("ExpoHomekit")
);
...
function useCharacteristic(homeUUID, accessoryUUID, charType) {
  const [char, setChar] = useState(void 0);
  useEffect(() => {
